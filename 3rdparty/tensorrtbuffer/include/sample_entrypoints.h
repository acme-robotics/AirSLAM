...
// TensorRT 10 removed the Caffe and UFF parsers (NvCaffeParser.h / NvUffParser.h).
// AirSLAM only uses the ONNX parser and none of these entrypoints are referenced,
// so the legacy-parser includes/declarations/definitions are dropped.
#include "NvInfer.h"
